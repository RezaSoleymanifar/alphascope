...
def test_arxiv_poller_smoke():
    ...
    from alphascope.sources.arxiv import poll_arxiv
    rows = poll_arxiv(n=3)
...
def test_alphaarchitect_poller_smoke():
    ...
    from alphascope.sources.alpha_architect import poll_alpha_architect
...
def test_nber_poller_smoke():
    ...
    from alphascope.sources.nber import poll_nber
